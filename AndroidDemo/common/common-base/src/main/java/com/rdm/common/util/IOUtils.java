...
public class IOUtils {
     ...
     * before using {@link com.rdm.common.util.IOUtils#toByteArray(java.io.InputStream, int)} to read into the byte array.
     ...
     * @see com.rdm.common.util.IOUtils#toByteArray(java.io.InputStream, int)
     * @since 2.1
     */
     ...
     * {@link com.rdm.common.util.IOUtils.LineIterator#close()} or {@link com.rdm.common.util.IOUtils.LineIterator#closeQuietly(com.rdm.common.util.IOUtils.LineIterator)}.
     * <p>
     ...
     * @since 2.3
     */
    public static Iterator<String> lineIterator(InputStream input, Charset encoding) throws IOException {
     ...
     * @since 1.2
     */
    public static Iterator<String> lineIterator(InputStream input, String encoding) throws IOException {
    ...
    /*pacage*/static class StringBuilderWriter extends Writer {
