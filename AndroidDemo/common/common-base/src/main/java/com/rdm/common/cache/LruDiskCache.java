 ...
 * value.
 * </ul>
 * Every {@link #edit} call must be matched by a call to {@link com.rdm.common.cache.LruDiskCache.Editor#commit}
 * or {@link com.rdm.common.cache.LruDiskCache.Editor#abort}. Committing is atomic: a read observes the full set
    ...
    public static LruDiskCache open(File directory, int appVersion, int valueCount, long maxSize)
        ...
        if (cache.journalFile.exists()) {
            try {
                ...
                ILog.e(LruDiskCache.class, "DiskLruCache "
                        + directory
                        + " is corrupt: "
