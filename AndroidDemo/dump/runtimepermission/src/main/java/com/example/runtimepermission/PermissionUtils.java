...
//            permissionGrant.onPermissionGranted(requestCode);
            permissionGrant.onNoPermissionNeeded();
        }
    }
    ...
    private static void requestMultiResult(Activity activity, String[] permissions, int[] grantResults, PermissionGrant permissionGrant) {
        ...
        //all permission success
        if (notGranted.size() == 0) {
            //全部权限申请成功
//            Toast.makeText(activity, "所有权限申请成功" + notGranted, Toast.LENGTH_SHORT)
//                    .show();
            permissionGrant.onPermissionGranted(CODE_MULTI_PERMISSION);
        } else {
            //打开设置面板
            openSettingActivity(activity, "当前应用缺少必要的权限，请点击“设置”-“权限”打开所需权限!");
        }
    ...
    public static void requestMultiPermissions(final Activity activity, String[] requestPermissions, PermissionGrant grant) {
        ...
        if (permissionsList.size() > 0) {
            ...
            showMessageOKCancel(activity, "当前应用缺少读写和GPS定位权限，是否允许申请对应权限！",
