            ...
            if ("IN".equalsIgnoreCase(op)) {
                ...
                if (items != null) {
                    ...
                    for (Object item : items) {
                        Object itemColValue = ColumnEntity.convert2DbColumnValueIfNeeded(item);
                ...
                if (items != null) {
                    ...
                    Object startColValue = ColumnEntity.convert2DbColumnValueIfNeeded(start);
                    Object endColValue = ColumnEntity.convert2DbColumnValueIfNeeded(end);
                ...
                value = ColumnEntity.convert2DbColumnValueIfNeeded(value);
