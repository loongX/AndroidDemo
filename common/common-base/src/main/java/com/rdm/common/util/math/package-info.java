 ...
 * These include classes to a {@link com.rdm.common.util.math.Fraction} class, various utilities for random numbers, and the flagship class, {@link com.rdm.common.util.math.NumberUtils} which contains a handful of classic number functions.</p>
 *
 * <p>There are two aspects of this package that should be highlighted.
 * The first is {@link com.rdm.common.util.math.NumberUtils#createNumber(String)}, a method which does its best to convert a String into a {@link java.lang.Number} object.
 ...
 * NumberUtils also has a related {@link com.rdm.common.util.math.NumberUtils#isNumber(String) isNumber(String)} method.</p>
 *
 * @since 2.0
 * @version $Id: package-info.java 1559146 2014-01-17 15:23:19Z britter $
 */
package com.rdm.common.util.math;
