package com.example.uidemo.slideunlockview.view;
...
public class SlideUnlockView extends View{
    ...
    Handler handler = new Handler() {
        public void handleMessage(android.os.Message msg) {
            if (msg.what == 0) {
                // 如果x还大于0，就人为的设置缓慢移动到最左端，每次移动距离设置为背景宽的/80
                if (x > 0) {
                    x = x - blockBackgoundWidth * 1.0f / 80;
                    // 刷新界面
                    postInvalidate();
                    // 设置继续移动
...
//        String namespace = "http://schemas.android.com/apk/res/com.example.uidemo";
